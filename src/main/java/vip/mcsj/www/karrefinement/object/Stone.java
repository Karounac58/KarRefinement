...
public class Stone implements IStone {
     ...
     */
    public Stone(String identifier, String name, List<String> lore, List<Double> probability, Material type, int data, int[] dropLevels, int customModelData,String nbt) {
