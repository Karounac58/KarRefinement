 ...
 */
public class DarkChangeIRefinementStrategy implements IRefinementStrategy {
...
//        }
    ...
    @Override
    public String getId() {
        return "refinement_strategy:dark_change";
    }
    ...
    public boolean canHandle(OfflinePlayer player, ItemStack equipment, IStone stone) {
        return KarRefinement.dcdm.getPlayerDarkChangeData(player) != null;
    }
}
